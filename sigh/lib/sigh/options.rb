    ...
    def self.available_options
      ...
      [
        ...
        FastlaneCore::ConfigItem.new(key: :skip_fetch_profiles,
                                     ...
                                     default_value: false,
                                     short_option: "-w"),
        FastlaneCore::ConfigItem.new(key: :download_profiles_by_name,
                                     env_name: "SIGH_PROFILES_BY_NAME",
                                     description: "Store downloaded provisioning profiles by their familiar name, rather than naming them by app ID",
                                     is_string: false,
                                     default_value: false,
                                     short_option: "-d"),
